...
our $execdir = "/local/jrodriguezr/server_casp/servers/psipred/psipred3.5/bin";  # path to PSIPRED V2 binaries
our $datadir = "/local/jrodriguezr/server_casp/servers/psipred/psipred3.5/data"; # path to PSIPRED V2 data files
...
our $pdbdir  =  "/local/jrodriguezr/databases/hhsuite/pdb70_08May14.pdb";            # where are the pdb files? (pdb/divided directory will also work)
our $dsspdir =  "/local/jrodriguezr/databases/dssp/14_may";          # where are the dssp files? Used in addss.pl
our $dssp    =  "/home/jrodriguezr/bin/dssp";  # where is the dssp binary? Used in addss.pl
##############################################################################################
